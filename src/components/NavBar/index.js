    ...
    <>
      <Nav scrollNav={scrollNav}>
        <NavbarContainer>
          ...
          <MobileIcons onClick={toggle} style={{ marginTop: "-16px" }}>
            <FaBars />
          </MobileIcons>
          <NavMenu style={{ margin: "10px", marginLeft: "150px" }}>
            <NavItem>
              <NavLinks to="/">Meet Our Agents</NavLinks>
            </NavItem>
            {/* 
            ...
            <NavItem>
              <NavLinks to="/curriculum">Flats</NavLinks>
            </NavItem>
            <NavItem>
              <NavLinks to="/curriculum">Self-Con</NavLinks>
            </NavItem>
            <NavItem>
              <NavLinks to="/curriculum">Store/Shops</NavLinks>
            </NavItem>
            <NavItem>
              <NavLinks to="/curriculum">
                {" "}
            ...
            <NavItem>
              {/* {current ? <NavLinks to="/dasboard">Dashboard</NavLinks> : null} */}
            </NavItem>
          </NavMenu>
