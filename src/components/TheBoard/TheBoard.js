...
import "./TheBoard.css";
import BoardHome from "../BaordHome/BoardHome";
  ...
  const drawer = (
    <div>
      ...
      <List>
        ...
        <div className="MatNavContSt">
          <PublishRoundedIcon style={{ color: "#0373ab", fontSize: "30px" }} />
      ...
      <List>
        ...
        <div className="MatNavContSt">
          <HomeWorkRoundedIcon style={{ color: "#0373ab", fontSize: "30px" }} />
